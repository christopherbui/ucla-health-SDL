...
output_dir <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 1 analysis/Output")
fout <- c("listHaloOut_panel2_set1_08192025.txt")

# ----- PANEL 2, SET 2 ---------------------------------------------------------
inputParentFolder <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/",
                           "20241121 CIRM Panel 2 Set 2 analysis/",
                           "20241121 CIRM Panel 2 Set 2 analysis ObjectData", sep="")
name_summary_file <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 2 analysis/",
                           "20241121 CIRM Panel 2 Set 2 analysis.csv", sep="")
output_dir <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 2 analysis/Output")
fout <- c("listHaloOut_panel2_set2_08192025.txt")
...
# new ROI
tmps_slideID <- matrix(NA, nrow(tmps_cond1), 4)
for (i in c(1:nrow(tmps_cond1))) {
  tmp_str <- unlist(strsplit(tmps_cond1[i, 1], split=" "))
  if (length(tmp_str) > 2) {
    # PANEL 2, BATCH 1
    # IN OBJECT FILE NAME, THERE IS SPACE: 'hpanel 2'
    # tmps_slideID[i, 1] <- paste0(tmp_str[[2]], tmp_str[[3]])
    # tmps_slideID[i, 2] <- tmp_str[[4]] #******
    # tmps_slideID[i, 3] <- tmp_str[[5]] #******
    # 
    # new_roi <- paste(tmp_str[[4]], tmp_str[[5]], tmp_str[[6]], sep="_") #******
    # tmps_slideID[i, 4] <- new_roi
    
    # PANEL 2, BATCH 2
    # IN OBJECT FILE NAME, THERE IS NO SPACE: 'hpanel2'
    tmps_slideID[i, 1] <- tmp_str[2] #******
    tmps_slideID[i, 2] <- tmp_str[3] #******
    tmps_slideID[i, 3] <- tmp_str[4] #******
...
colnames(listFiles) <- c("originalFileName", "Panel", "PathologicalID", "BlockID",
...
qcFilePath <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 1 analysis/Output/",
                    "listHaloOut_panel2_set1_08192025.txt", sep="")



fin_header_object <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 1 analysis/",
                           "object_header_panel2_set1_081925.csv", sep="")
fin_header_summary <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/summary_header_panel2_set1_081925.csv")

fin_conversion <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 1 analysis/Output/",
                        "MIF_panel2hu_batch1_fileConversion_081925.txt", sep="")
fout_conv <- c("MIF_panel2hu_batch1_oldnew_QuantifiedFile.txt")


outputParentFolder <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 1 analysis/Regenderated Data")
...
qcFilePath <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 2 analysis/Output/",
                    "listHaloOut_panel2_set2_08192025.txt", sep="")



fin_header_object <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 2 analysis/",
                           "object_header_panel2_set2_081925.csv", sep="")
fin_header_summary <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 2 analysis/",
                            "summary_header_panel2_set2_081925.csv", sep="")
fin_conversion <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 2 analysis/Output/",
                        "MIF_panel2hu_batch2_fileConversion_081925.txt", sep="")
fout_conv <- c("MIF_panel2hu_batch2_oldnew_QuantifiedFile.txt")


outputParentFolder <- paste("D:/CHRISTOPHER_BUI/CIRM_MIF/Data/20241121 CIRM Panel 2 Set 2 analysis/Regenerated Data")
suffix_obj <- c("_hpanel2_object_results.csv") #******
suffix_summary <- c("_hpanel2_Summary_Results.csv") #******
...
conversion_file <- qcFile %>%
  select(originalFileName, SumFileName, originalROI, newROI, Panel, PathologicalID, BlockID, jobID)
